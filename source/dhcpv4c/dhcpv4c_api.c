...
*/
/*
   The returned value should map to values defined by COSA_DML_DHCPC_STATUS
   in ccsp-p-and-m/source/TR-181/include/cosa_dhcpv4_apis.h, ie:

     COSA_DML_DHCPC_STATUS_Init         : 1
     COSA_DML_DHCPC_STATUS_Selecting    : 2
