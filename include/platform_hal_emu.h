...
#ifndef __PLATFORM_HAL_EMU_H__
#define __PLATFORM_HAL_EMU_H__
...
INT platform_hal_GetManufacturerOUI(CHAR* pValue); //In MAC addresses, the OUI is combined with a 24-bit number (assigned by the owner or 'assignee' of the OUI) to form the address. The first three octets of the address are the OUI.
